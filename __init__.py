...
from .psd_layer_composer import NODE_CLASS_MAPPINGS as PSD_LAYER_MAPPINGS
from .psd_layer_composer import NODE_DISPLAY_NAME_MAPPINGS as PSD_LAYER_DISPLAY
from .gpt_image2_product_studio_runninghub import NODE_CLASS_MAPPINGS as RH_PRODUCT_STUDIO_MAPPINGS
from .gpt_image2_product_studio_runninghub import NODE_DISPLAY_NAME_MAPPINGS as RH_PRODUCT_STUDIO_DISPLAY
from .h3_prompt_director_runninghub import NODE_CLASS_MAPPINGS as RH_H3_DIRECTOR_MAPPINGS
from .h3_prompt_director_runninghub import NODE_DISPLAY_NAME_MAPPINGS as RH_H3_DIRECTOR_DISPLAY
...
NODE_CLASS_MAPPINGS = {
    ...
    **PSD_LAYER_MAPPINGS,
    **RH_PRODUCT_STUDIO_MAPPINGS,
    **RH_H3_DIRECTOR_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **PSD_LAYER_DISPLAY,
    **RH_PRODUCT_STUDIO_DISPLAY,
    **RH_H3_DIRECTOR_DISPLAY,
}
